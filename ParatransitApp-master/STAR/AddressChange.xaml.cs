...
namespace STAR
{
    ...
    public partial class AddressChange : ContentPage
    {
        private string HomeAddress, DSTARID;
        string ONLINE_SID;
        public AddressChange(string O_SID)
        {
            InitializeComponent();
            ONLINE_SID = O_SID;
        }
        ...
        async void ChangeAddressClicked(object sender, EventArgs e)
        {
            HomeAddress = CHA_ADD.Text;
            DSTARID = ONLINE_SID;
            ...
            if (ValidateALL() == true)
            {
                ...
                string queryString = "UPDATE dbo.UserAccounts SET  HomeAddress = ('" + HomeAddress + "') WHERE STARID = ('" + DSTARID + "')";
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    try
                    {
                        ...
                        await DisplayAlert("SUCCESS", "Your Address has been changed", "Ok");
                    }
                    catch (Exception ex)
                    {
